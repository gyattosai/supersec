...
export function QuestionAnswerControls({ answer, onAnswerChange, isOfficial, onOfficialChange, changeSummary, onChangeSummaryChange, showChangeSummary }: QuestionAnswerControlsProps) {
  return (
