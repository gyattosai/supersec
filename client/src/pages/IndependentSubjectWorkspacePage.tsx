...
export default function IndependentSubjectWorkspacePage() {
  ...
  const workspaceItems: WorkspaceItem[] = [
    { title: "Class details", description: "Subject code, professor, term, and core class information.", href: `/app/subjects/${subjectId}/details`, icon: Pencil },
    { title: "Students (Master List)", description: "Manage this Subject’s independent roster and secretary-only notes.", href: `/app/subjects/${subjectId}/students`, icon: Users },
    { title: "Schedule & No Class", description: "Set meeting times and publish changes for holidays, weather, or events.", href: `/app/subjects/${subjectId}/schedule`, icon: CalendarDays },
