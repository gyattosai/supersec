...
export function FocusedAttendancePage() {
  ...
  const fixedSchedule = subject.data?.meetingDays.map(day => `${weekdayNames[day.weekday]}${formatTimeRange12Hour(day.startTime, day.endTime)}`).join(" · ") || "No fixed weekday schedule";
