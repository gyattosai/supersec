...
> = {
  ...
  sky: {
    ...
    cardBg: "bg-sky-500/8 dark:bg-sky-950/25",
  ...
  amber: {
    ...
    cardBg: "bg-amber-500/8 dark:bg-amber-950/25",
  ...
  emerald: {
    ...
    cardBg: "bg-emerald-500/8 dark:bg-emerald-950/25",
  ...
  purple: {
    ...
    cardBg: "bg-purple-500/8 dark:bg-purple-950/25",
  ...
  rose: {
    ...
    cardBg: "bg-rose-500/8 dark:bg-rose-950/25",
