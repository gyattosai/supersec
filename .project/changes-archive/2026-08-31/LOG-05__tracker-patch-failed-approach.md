# Change LOG-05 — Failed tracker patch approach record

- **Operation:** log-entry
- **Target file(s):** `.project/failed-approaches.md`
- **Summary:** Create the initial failed-approach log with the lesson for tracker status edits.
- **Content:**
  ```markdown
  ...
  ```
- **Reason:** The failed-approach workflow prevents repeating broad context-free tracker edits.
